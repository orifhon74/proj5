public class Compiler {
    ...
    public void Parse()
    {
        ...
        try
        {
            ParseTree.Node.OptToString opt = ParseTree.Node.OptToString.Default; // no-print comments that are for running environment
        ...
        try
        {
            ParseTree.Node.OptToString opt = ParseTree.Node.OptToString.CommentExecEnv; // print comments that are for running environment
            String[] lines = parser.parsetree_program.ToStringList(opt);
            System.out.println("================================================================================");
